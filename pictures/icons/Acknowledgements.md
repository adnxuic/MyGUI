...
<a href="https://iconscout.com/icons/close" class="text-underline font-size-sm" target="_blank">Close</a> by <a href="https://iconscout.com/contributors/unicons" class="text-underline font-size-sm" target="_blank">Unicons Font</a> </br>
<a href="https://iconscout.com/icons/add-new" class="text-underline font-size-sm" target="_blank">Add New</a> by <a href="https://iconscout.com/contributors/unicons" class="text-underline font-size-sm">Unicons Font</a> on <a href="https://iconscout.com" class="text-underline font-size-sm">IconScout</a></br>
<a href="https://iconscout.com/icons/remove" class="text-underline font-size-sm" target="_blank">Remove</a> by <a href="https://iconscout.com/contributors/unicons" class="text-underline font-size-sm">Unicons Font</a> on <a href="https://iconscout.com" class="text-underline font-size-sm">IconScout</a></br>

<a href="https://iconscout.com/icons/menu" class="text-underline font-size-sm" target="_blank">Menu</a> by <a href="https://iconscout.com/contributors/eva-icons" class="text-underline font-size-sm">Akveo</a> on <a href="https://iconscout.com" class="text-underline font-size-sm">IconScout</a></br>

<a href="https://iconscout.com/icons/simplify" class="text-underline font-size-sm" target="_blank">Simplify</a> by <a href="https://iconscout.com/contributors/mcgandhi61" class="text-underline font-size-sm">Mohit Gandhi</a> on <a href="https://iconscout.com" class="text-underline font-size-sm">IconScout</a></br>

<a href="https://iconscout.com/icons/style" class="text-underline font-size-sm" target="_blank">Style</a> by <a href="https://iconscout.com/contributors/rezafahlevimrf" class="text-underline font-size-sm">Muhammad Reza fahlevi</a> on <a href="https://iconscout.com" class="text-underline font-size-sm">IconScout</a></br>

<a href="https://iconscout.com/icons/dark" class="text-underline font-size-sm" target="_blank">dark</a> by <a href="https://iconscout.com/contributors/ateeq" class="text-underline font-size-sm" target="_blank">Ateeq Ahmed</a> on <a href="https://iconscout.com" class="text-underline font-size-sm" target="_blank">IconScout</a></br>
...
<a href="https://iconscout.com/icons/layout" class="text-underline font-size-sm" target="_blank">in_axes</a> by <a href="https://iconscout.com/contributors/mahira-modanwal" class="text-underline font-size-sm">Mahira Modanwal</a> on <a href="https://iconscout.com" class="text-underline font-size-sm">IconScout</a>
