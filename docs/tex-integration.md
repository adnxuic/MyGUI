...
| `usetex` | Text or Annotation component, schema v23 | User-requested render mode for that text-like component |
...
unavailable. The effective override is not added to schema v23.
