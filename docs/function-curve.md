...
A function curve stores expression, x_start, and x_stop in its component data and its visual properties in the schema-v15 component tree. See [Project Files](project-files.md).
