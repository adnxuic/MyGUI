...
The **X Label** component represents the dimensional label of the horizontal X Axis. It provides complete typography formatting, alignment, multiline wrapping, Mathtext equations, and optional LaTeX typesetting.
...
Schema v15 persists X Label as `kind: "text"`, `role: "x_label"`, with `selector: {"axis_name": "x"}` under its parent Axes.
