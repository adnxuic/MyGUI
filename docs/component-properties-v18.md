# Component Properties (schema v18)
...
Schema v18 retains the exact eight-field `ComponentState` record:
...
This coordination changes no schema-v18 field or record shape.
...
Schema v18 extends schema v17 by introducing the required `fit_input_range` field
for `Fit Curve` components (`line/fit_curve`). When saving, projects record
`schema_version: 18`. Existing strictly valid schema-v17 files migrate in memory
by injecting the default `fit_input_range: {"kind": "all"}` into Fit Curves. Stepwise
migrations from v10–v16 promote into schema v17 and then v18. Prior schema versions
(v10–v17) reject `fit_input_range`.
