...
- Empty data remains a valid registered and persisted component where the
  domain permits it.
- Every dynamic Controller key has a parameterized schema-v12 save/open test;
...
- Deletion, data refresh semantics, stable-ID save/open, and schema-v12
