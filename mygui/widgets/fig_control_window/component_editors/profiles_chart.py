    ...
    ComponentRole.LINE: EditorProfile(
        ...
        (
            ...
            SectionSpec(
                ...
                "Appearance",
                _line_appearance,
                property_keys=LineAppearanceSection.PRIMARY_KEYS,
            ),
            SectionSpec(
                "advanced",
                "Advanced",
                _properties(*LineAppearanceSection.ADVANCED_KEYS),
                collapsed=True,
                property_keys=LineAppearanceSection.ADVANCED_KEYS,
            ),
        ),
...
SCATTER_PROFILE = EditorProfile(
    ...
    (
        ...
        SectionSpec(
            ...
            "Appearance",
            _scatter_appearance,
            property_keys=ScatterAppearanceSection.PRIMARY_KEYS,
        ),
        SectionSpec(
            "advanced",
            "Advanced",
            _properties(*ScatterAppearanceSection.ADVANCED_KEYS),
            collapsed=True,
            property_keys=ScatterAppearanceSection.ADVANCED_KEYS,
        ),
    ),
    placement=EditorPlacement.CHART,
    tree=TreePresentationSpec(
