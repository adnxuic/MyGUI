...
SECONDARY_AXIS_PROFILE = EditorProfile(
    ...
    (
        ...
        SectionSpec(
            "label", "Label",
            _secondary_axis_properties("label"),
            property_keys=("label",),
        ),
        SectionSpec(
            "label_details", "Label details",
            _secondary_axis_properties("label_pad", "label_rotation", "label_font"),
            collapsed=True,
            property_keys=("label_pad", "label_rotation", "label_font"),
        ),
        SectionSpec(
...
IN_AXES_ZOOM_PROFILE = EditorProfile(
    ...
    (
        SectionSpec(
            "layout",
            "Layout",
            _properties("bounds", "visible"),
            property_keys=("bounds", "visible"),
        ),
        SectionSpec(
            "range",
            "Zoom range",
        ...
        SectionSpec(
            ...
            collapsed=True,
            property_keys=("facecolor", "frameon", "edgecolor", "linewidth", "zorder"),
        ),
        SectionSpec(
            "indicator",
            "Indicator",
...
IN_AXES_IMAGE_PROFILE = EditorProfile(
    ...
    (
        ...
        SectionSpec(
            "display",
            "Display",
            _properties("opacity", "fit_mode"),
            property_keys=("opacity", "fit_mode"),
        ),
        SectionSpec(
            "frame",
            "Frame",
