...
class AxesLayoutInput(QWidget):
    ...
    def _build_axes_page(self, axes_page: QWidget, default_view: AxesViewSpec) -> None:
        ...
        self.x_major_grid_input.setChecked(bool(default_view.x_major_grid))
        self.x_minor_grid_input.setChecked(bool(default_view.x_minor_grid))
        self.y_major_grid_input.setChecked(bool(default_view.y_major_grid))
        self.y_minor_grid_input.setChecked(bool(default_view.y_minor_grid))
