...
from mygui.widgets.title_bar.titlebar_dialog.py_chart_dialog import chart_dialog_dict
...
class SelectorMenuBar(QFrame):
    ...
    def __init__(self, stacklayout_bottom=None, figure_window=None):
        ...
        # 添加按钮
        self.style_button = SelectMenuButton('style', icon_path('style.svg'))
        ...
        self.layout_button = SelectMenuButton('layout', icon_path('layout.svg'))
        ...
        self.chart_button = SelectMenuButton('chart', icon_path('chart.svg'))
        ...
        self.element_button = SelectMenuButton('element', icon_path('element.svg'))
...
class MenuBar(QFrame):
    ...
    def __init__(self, table: PyTable, figure_window=None):
        ...
        # 创建触发文件菜单的按钮
        self.file_button = MenuButton('file', icon_path('file.svg'), self)
...
class ControlBar(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        # 添加最小化按钮
        minmize_button = QPushButton(QIcon(icon_path("minimize.svg")), "")
        ...
        # 添加关闭按钮
        button_close = QPushButton(QIcon(icon_path("close.svg")), "")
...
class SelectorChartMenuBar(ResponsiveActionGallery):
    ...
    def __init__(self, figure_window=None):
        ...
        for name, dialog_type in chart_dialog_dict.items():
            self.add_dialog_action(
                name,
                icon_path(f"chart_images/{name}.svg"),
