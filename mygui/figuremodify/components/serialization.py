...
from mygui.figuremodify.style_base.color_models import ColorCycleState, normalize_color
from mygui.figuremodify.axes_layout import stable_layout_id
...
def legacy_figure_to_v6(
    ...
    """Legacy conversion utility; the project loader does not accept this format."""
...
def normalize_v6_figure(figure_snapshot: dict[str, Any]) -> dict[str, Any]:
    """Legacy normalization utility; not reachable from strict-v9 loading."""
...
def validate_v6_figure(
    ...
    """Legacy validation utility; not reachable from strict-v9 loading."""
...
def v6_figure_to_legacy(figure_snapshot: dict[str, Any]) -> dict[str, Any]:
    """Legacy export utility; strict-v9 project IO does not call it."""
