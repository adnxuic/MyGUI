...
_ICON_DIRECTORY = _REPOSITORY_ROOT / "pictures" / "icons" / "layout_images"
...
class AxesLayoutPreset:
    ...
    def icon_path(self) -> str:
        """Return the root-relative path used by the Qt resource callers."""

        return f"pictures/icons/layout_images/{self.icon}"
