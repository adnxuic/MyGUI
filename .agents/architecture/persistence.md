...
MyGUI saves and validates exact integer schema version 13. Component business
state is the schema-v13 tree; profile selection, Section expansion, QWidget
state, callbacks, typed tree projection keys, and other UI-only data are
excluded. Strictly valid schema-v12 files migrate in memory to v13; strictly
valid schema-v11 and schema-v10 files migrate through every intervening version
...
reconciliation pass before validating the Registry tree and schema-v13
...
and `docs/component-properties-v13.md` (or its successor) in the same change.
