...
Bar record. Strictly valid schema-v19 files migrate through v20 by advancing
...
field) to v21; strictly valid schema-v17 files migrate through v18 to v21;
strictly
...
schema-v21 snapshot. None of that state is registered or shown before the
...
the schema-v21 blueprint is validated.
...
The template Figure is a schema-v21 component-tree blueprint with template-
...
reconciliation pass before validating the Registry tree and schema-v21
...
and `docs/component-properties-v21.md` in the same change.
