...
- integer schema-v17 project files
...
of a programmatic create. `load_project_figure_snapshot`, schema-v17 open,
...
fields stay `READ_ONLY_FUTURE`. Do not put these keys in schema v17 or
`docs/component-properties-v17.md`. Title, Axis Label, Legend, limits, scale,
...
- Isolation tests prove settings are absent from schema v17, Undo/Redo, dirty
