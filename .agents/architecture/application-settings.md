...
- integer schema-v18 project files
...
of a programmatic create. `load_project_figure_snapshot`, schema-v18 open,
...
fields stay `READ_ONLY_FUTURE`. Do not put these keys in schema v18 or
`docs/component-properties-v18.md`. Title, Axis Label, Legend, limits, scale,
...
- Isolation tests prove settings are absent from schema v18, Undo/Redo, dirty
