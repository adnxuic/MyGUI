...
- integer schema-v22 project files
...
of a programmatic create. `load_project_figure_snapshot`, schema-v22 open,
...
fields stay `READ_ONLY_FUTURE`. Do not put these keys in schema v22 or
`docs/component-properties-v22.md`. Title, Axis Label, Legend, limits, scale,
...
- Isolation tests prove settings are absent from schema v22, Undo/Redo, dirty
