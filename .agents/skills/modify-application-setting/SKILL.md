...
weaken `CORE-PERSISTENCE-V19` or `CORE-PROJECT-HISTORY`.
...
the application setting out of schema v19.
...
5. Figure creation, export, and component creation consume
   ...
   `PropertySpec.default` or schema v19. A new Axes Inspector property must
...
7. Update architecture pages in the same change. Update user Settings
   ...
   keys to `docs/component-properties-v19.md`.
...
- Writing application preferences into schema v19, Undo/Redo, dirty
