...
synchronization in that order. Run both architecture scanners on the affected
scope. Inspect disposal, repeated signal binding, Timer/Thread ownership, stale
async callbacks, recursive signals, and render rollback before changing code.
