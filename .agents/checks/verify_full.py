...
APPLICATION_TEST_MODULES = {
    ...
    "test_field_2d_component": (ISOLATION_GUI_MODULE, 90.0),
    "test_field_2d_grid": (ISOLATION_CORE, 0.3),
    ...
    "test_axes_geometry": (ISOLATION_GUI_MODULE, 6.0),
    "test_annotation_component": (ISOLATION_GUI_MODULE, 10.0),
    "test_secondary_axis_component": (ISOLATION_GUI_MODULE, 10.0),
    ...
    "test_ui_components": (ISOLATION_GUI_MODULE, 3.0),
    "test_ui_layout_signatures": (ISOLATION_GUI_MODULE, 30.0),
    "test_inspector_geometry": (ISOLATION_GUI_MODULE, 600.0),
...
def main() -> int:
    ...
    result = task_result(
        ...
        persistence_impact="MyGUI schema-v23 behavior and predecessor migrations are verified.",
    )
