...
def main() -> int:
    ...
    return finish(task_result("project-io", verification, persistence_impact="Schema-v14 behavior, strict v13 migration, and chained v12/v11/v10 migration verified."), args.json_out, "project-io")
