...
def main() -> int:
    ...
    return finish(task_result("project-io", verification, persistence_impact="Schema-v13 behavior, strict v12 migration, and chained v11/v10 migration verified."), args.json_out, "project-io")
