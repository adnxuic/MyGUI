...
def main() -> int:
    ...
    return finish(task_result("project-io", verification, persistence_impact="Schema-v12 behavior, strict v11 migration, and chained v10 migration verified."), args.json_out, "project-io")
